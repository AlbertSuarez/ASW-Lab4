...
try{
	$sClient = new SoapClient('http://localhost:8080/wslab04/WSLabService.wsdl', array('trace' => 1));
	...
	/* Task #2: Write your code here. Uses de function xmlpp (implemented below)
